...
/** Footer used on marketing pages. Avoids linking to `/for-companies` and `/rental-account-dashboard`. */
export function Footer1() {
  const formState = useForm();
  return (
    <footer id="footer1" className="px-[5%] py-12 md:py-18 lg:py-20">
      <div className="container">
        <div className="grid grid-cols-1 gap-x-[8vw] gap-y-12 pb-12 md:gap-y-16 md:pb-18 lg:grid-cols-[0.75fr_1fr] lg:gap-y-4 lg:pb-20">
          ...
          <div className="grid grid-cols-1 items-start gap-y-10 sm:grid-cols-3 sm:gap-x-6 md:gap-x-8 md:gap-y-4">
            ...
            <div
              id="relume-social"
              className="flex flex-col items-start justify-start scroll-mt-24"
            >
        ...
        <div className="flex flex-col-reverse items-start justify-between pb-4 pt-6 text-sm md:flex-row md:items-center md:pb-0 md:pt-8">
          <p className="mt-6 md:mt-0">
            © {new Date().getFullYear()} ToolShare Ledger. All rights reserved.
          </p>
          <ul className="grid grid-flow-row grid-cols-[max-content] justify-center gap-y-4 text-sm md:grid-flow-col md:gap-x-6 md:gap-y-0">
            ...
            <li className="underline">
              <Link to="/faqs">Cookies settings</Link>
            </li>
            <li className="underline">
