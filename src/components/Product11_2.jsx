        ...
        <div className="mb-12 grid grid-cols-1 items-end gap-12 md:mb-18 md:grid-cols-[1fr_max-content] lg:mb-20 lg:gap-20">
          <div className="max-w-lg">
            ...
            <p className="md:text-md">
              Maximum capability without the premium price tag.
            </p>
          </div>
            ...
            <CarouselContent className="ml-0">
              ...
              <CarouselItem className="basis-[95%] pl-0 pr-6 sm:basis-4/5 md:basis-1/2 md:pr-8 lg:basis-[33%] lg:pr-12">
                <a href="#" className="font-semibold md:text-md">
                  ...
                  <div className="mb-2">
                    <h3>Circular saw</h3>
                    <div className="text-sm font-normal">Brushless</div>
                  </div>
              ...
              <CarouselItem className="basis-[95%] pl-0 pr-6 sm:basis-4/5 md:basis-1/2 md:pr-8 lg:basis-[33%] lg:pr-12">
                <a href="#" className="font-semibold md:text-md">
                  ...
                  <div className="text-md md:text-lg">$31</div>
                </a>
              </CarouselItem>
              <CarouselItem className="basis-[95%] pl-0 pr-6 sm:basis-4/5 md:basis-1/2 md:pr-8 lg:basis-[33%] lg:pr-12">
                <a href="#" className="font-semibold md:text-md">
              ...
              <CarouselItem className="basis-[95%] pl-0 pr-6 sm:basis-4/5 md:basis-1/2 md:pr-8 lg:basis-[33%] lg:pr-12">
                <a href="#" className="font-semibold md:text-md">
                  ...
                  <div className="mb-2">
                    ...
                    <div className="text-sm font-normal">Lightweight</div>
                  </div>
                  <div className="text-md md:text-lg">$26</div>
                </a>
              </CarouselItem>
              <CarouselItem className="basis-[95%] pl-0 pr-6 sm:basis-4/5 md:basis-1/2 md:pr-8 lg:basis-[33%] lg:pr-12">
                <a href="#" className="font-semibold md:text-md">
                  ...
                  <div className="mb-2">
                    <h3>Miter saw</h3>
                    <div className="text-sm font-normal">Sliding</div>
                  </div>
                  <div className="text-md md:text-lg">$61</div>
                </a>
              </CarouselItem>
            </CarouselContent>
