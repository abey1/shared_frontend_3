            ...
            <CarouselContent>
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "Showed up in perfect condition and did exactly what we
                    needed for the job."
                  </blockquote>
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "The support team answered my questions fast and the tool
                    worked flawlessly."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "Best rental experience we've had. Equipment was clean and
                    ready to go."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "Saved us thousands compared to buying and this thing runs
                    like new."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "Delivery was on time and the insurance coverage gave us
                    peace of mind."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "We've rented from them three times now and never had a
                    single issue."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
              ...
              <CarouselItem className="basis-full">
                <div className="flex w-full flex-col items-start justify-between border border-border-primary p-6 md:p-8">
                  ...
                  <blockquote className="md:text-md">
                    "Professional operation from start to finish, exactly what
                    we expected."
                  </blockquote>
                  <div className="mt-5 flex w-full flex-col items-start gap-4 md:mt-6 md:w-auto md:flex-row md:items-center">
                    <div>
                    ...
                    <div>
                      ...
                      <p>Operations director, Phoenix</p>
                    </div>
                  </div>
                </div>
              </CarouselItem>
