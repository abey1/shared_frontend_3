...
export const Filters5 = () => {
  ...
  const getSelectedLabels = (filter) => {
    if (!selectedValues[filter].length) return "Select options";
    if (selectedValues[filter].length === 1) {
      return options.find((opt) => opt.value === selectedValues[filter][0])
        ?.label;
    }
  ...
  return (
    <section id="filters5" className="px-[5%] py-16 md:py-24 lg:py-28">
              ...
              <div className="mb-8 grid grid-cols-1 gap-x-8 gap-y-4 lg:grid-cols-4">
                ...
                <div>
                  ...
                  <Select value="" onValueChange={() => {}}>
                    <SelectTrigger>
                      <SelectValue
                        placeholder={getSelectedLabels("filterTwo")}
                      />
                    </SelectTrigger>
                    <SelectContent>
                      {options.map((option) => (
                        ...
                        >
                          <Checkbox
                            ...
                            checked={selectedValues.filterTwo.includes(
                              option.value,
                            )}
                            onCheckedChange={() =>
                ...
                <div>
                  ...
                  <Select value="" onValueChange={() => {}}>
                    <SelectTrigger>
                      <SelectValue
                        placeholder={getSelectedLabels("filterThree")}
                      />
                    </SelectTrigger>
                    <SelectContent>
                      {options.map((option) => (
                        ...
                        >
                          <Checkbox
                            ...
                            checked={selectedValues.filterThree.includes(
                              option.value,
                            )}
                            onCheckedChange={() =>
                ...
                <div>
                  ...
                  <Select value="" onValueChange={() => {}}>
                    <SelectTrigger>
                      <SelectValue
                        placeholder={getSelectedLabels("filterFour")}
                      />
                    </SelectTrigger>
                    <SelectContent>
                      {options.map((option) => (
                        ...
                        >
                          <Checkbox
                            ...
                            checked={selectedValues.filterFour.includes(
                              option.value,
                            )}
                            onCheckedChange={() =>
